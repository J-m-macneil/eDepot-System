...
public class Driver implements Schedulable, Serializable {
	...
	//Declares a 'getModel', to allow the protected variable to be accessed by a java class.
	public String getUserName() {
		return username;
	}

	//Declare a 'setUsername', to allow the protected variable to be accessed and update the value in a java class. 
	public void setUserName(String userName) {
		this.username = userName;
	}

	//Declares a 'getPassword', to allow the protected variable to be accessed by a java class.
	public String getPassWord() {
		return password;
	}

	//Declare a 'setPassword', to allow the protected variable to be accessed and update the value in a java class. 
	...
	//Declares a 'getSchedule' of class 'Driver', to allow the protected variable to be accessed by a java class.
	@Override
